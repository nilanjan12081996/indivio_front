    ...
    <div className="testi_slider_section">
        <div className="lg:w-full text-center pb-0">
            <Slider {...assets_slider_setting}>
                <div className="">
                    <Image src={assets_slide_07} alt="assets_slide_07" className='mb-0' />
                </div>
                <div className="">
                    <Image src={assets_slide_08} alt="assets_slide_08" className='mb-0' />
                </div>
                <div className="">
                    <Image src={assets_slide_07} alt="assets_slide_07" className='mb-0' />
                </div>
...
export default RecentlyUsedSlider5